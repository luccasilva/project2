...
fun testParserCases ([], brokenCase) = "SUCCESSO"
  | testParserCases ((x:string,y:expr)::t, brokenCase) = if (fromString(x) = y) then testParserCases(t, x) else x;

print(testParserCases(cases,""));
fromString(testParserCases(cases,""));